...
export function StatusBadge({ value }: { value: string }) {
  const labels: Record<string, string> = { pending: 'Pendiente', processing: 'Procesando', shipped: 'Despachado', delivered: 'Entregado', cancelled: 'Cancelado', refunded: 'Reembolsado', approved: 'Pagado', published: 'Publicado', draft: 'Borrador', archived: 'Archivado', hidden: 'Oculto', configured: 'Configurada', connected: 'Conectada', not_connected: 'No conectada', syncing: 'Sincronizando', paused: 'Pausado', active: 'Activo', inactive: 'Inactivo', abandoned: 'Abandonado', recovered: 'Recuperado', converted: 'Convertido', unsubscribed: 'Opt-out', expired: 'Archivado', recovery_queued: 'En cola', completed: 'Completado', partial: 'Parcial', running: 'En curso', review: 'Revisar', imported: 'Importado', available: 'Disponible', estimated: 'Estimado', unavailable: 'No disponible', limited: 'Limitado', out_of_stock: 'Agotado', suppressed: 'Suprimido', price_error: 'Error de precio', sync_error: 'Error de sync', unknown: 'Sin datos', error: 'Error', failed: 'Fallido', rejected: 'Rechazado', needs_review: 'Revisar' };
  const success = ['approved', 'delivered', 'published', 'configured', 'connected', 'completed', 'imported', 'available', 'active', 'recovered', 'converted'];
  const warning = ['pending', 'processing', 'shipped', 'needs_review', 'syncing', 'partial', 'running', 'review', 'limited', 'paused', 'abandoned', 'recovery_queued', 'estimated'];
  const danger = ['cancelled', 'refunded', 'error', 'failed', 'rejected', 'out_of_stock', 'suppressed', 'price_error', 'sync_error'];
