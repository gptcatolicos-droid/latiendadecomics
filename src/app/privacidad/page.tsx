  ...
  return (
    <div style={{ maxWidth: 760, margin: '0 auto', padding: '48px 24px 80px', fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif', color: '#222', lineHeight: 1.7 }}>
      ...
      {[
        ...
        { title: '6. Sus derechos (Habeas Data)', content: 'De conformidad con la Ley 1581 de 2012, usted tiene derecho a: Conocer, actualizar, rectificar y suprimir sus datos personales; Solicitar prueba de la autorización otorgada; Ser informado sobre el uso de sus datos; Presentar quejas ante la Superintendencia de Industria y Comercio; Revocar la autorización y/o solicitar la supresión del dato. Para ejercer estos derechos, envíe una solicitud a privacidad@latiendadecomics.com.' },
