  ...
  return (
    <div style={{ maxWidth: 760, margin: '0 auto', padding: '48px 24px 80px', fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif', color: '#222', lineHeight: 1.7 }}>
      ...
      {[
        ...
        { title: '10. Contacto', content: 'Para cualquier pregunta sobre estos Términos y Condiciones, puede contactarnos a través de WhatsApp al +57 318 707 9104 o por correo electrónico a superpoder@latiendadecomics.com.' },
      ].map((section, i) => (
